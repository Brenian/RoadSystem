...
public abstract class GUI {
	...
	/**
	 * Is called when the corresponding button is pressed to find the route 
	 * via A* between the two selected nodes
	 */
	protected abstract void onRoute();
	
	/**
	 * Is called when the corresponding button is pressed to find
	 * Articulation Points
	 */
	protected abstract void onArticulate();

	/**
	 * Is called when the mouse wheel is moved, and is passed the MouseEvent
	 * object.
	 */
	...
	/**
	 * Is called when the mouse is clicked and dragged, and is passed the
	 * MouseEvent object for that motion.
	 */
	...
	private void initialise() {
		...
		JButton articulate = new JButton("Points");
		articulate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				onArticulate();
				redraw();
			}
