...
public class SquaresExample extends GUI {
	...
	protected void onRoute() {
		getTextOutputArea().setText("Find Route");
	}

	@Override
	protected void onArticulate() {
		getTextOutputArea().setText("Articulation Points");
	}
	...
	protected void onScroll(MouseWheelEvent e) {
		getTextOutputArea().append("Mouse Scrolled: "+e.getWheelRotation());
	}

	@Override
	protected void onPress(MouseEvent e) {
		getTextOutputArea().append("Mouse Pressed");
	}

	@Override
	protected void onDrag(MouseEvent e) {
		getTextOutputArea().append("Mouse Dragged");
	}
